<template>
  <q-page padding>
    <div class="row q-col-gutter-xs">
      <div class="col">
        <q-input outlined type="number" v-model.number="state.weight" :label="t('common.weight')" />
      </div>
      <div class="col">
        <q-input outlined type="number" v-model.number="state.height" :label="t('common.height')" />
      </div>
      <div class="col">
        <q-input outlined v-model="state.text" :label="t('common.text')" />
      </div>
    </div>
    <div class="row q-col-gutter-xs q-mt-md">
      <div class="col">
        ...
        <br />
        <q-input outlined v-model="state.bgColor">
      ...
      <div class="col">
        ...
        <br />
        <q-input outlined v-model="state.textColor">
          <template v-slot:append>
            <q-icon name="colorize" class="cursor-pointer">
              <q-popup-proxy transition-show="scale" transition-hide="scale">
      ...
      <div class="col">
        ...
        <br />
        <q-select outlined v-model="state.extension" :options="extensionOptions" emit-value />
      </div>
    </div>
    <div class="row q-col-gutter-xs q-mt-md">
      <div class="col">
        <div class="mt-1">
          <div class="border rounded mt-5">
            <img
              ...
              v-bind:src="generationUrl"
              v-bind:style="{ wieght: state.weight }"
              :title="t('placeholder.placeholder_img')"
            />
          </div>
